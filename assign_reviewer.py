"""
Assign one or more content reviewers to one or more CHEP 2026 paper submissions.

Usage:
    python3 assign_reviewer.py <friendly_id> [<friendly_id> ...] --email <email> [<email> ...]

Example:
    python3 assign_reviewer.py 690 77 --email david.lange@cern.ch joe@example.com
"""
import argparse
import json
import sys
...
def main():
    ...
    parser.add_argument("--email", nargs="+", required=True,
                        metavar="EMAIL", help="Email address(es) of reviewer(s)")
    ...
    ok = assign("content_reviewer", contrib_ids, user_ids)
